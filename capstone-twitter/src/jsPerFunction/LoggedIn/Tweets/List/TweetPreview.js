  ...
  render() {
    return (
      <section
        ...
        style={{
          minWidth: "100%",
          display: "flex" /*gridTemplateColumns: "50px auto 50px"*/,
          borderBottom: "1px rgb(235, 233, 233) solid"
        }}
      >
        ...
        <section
          style={{ width: "100%", paddingRight: "40px", paddingLeft: "10px" }}
        >
          {" "}
          <Link
            to={this.props.linkTo}
            onClick={e => this.props.saveIDToState(e)}
            style={{
              textDecoration: "none",
              color: "inherit"
            }}
