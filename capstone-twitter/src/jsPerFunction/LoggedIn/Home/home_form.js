  ...
  render() {
    return (
      <div id="form_div">
        ...
        ></input>
        <br></br>
        <svg viewBox="0 0 24 24" className="img">
          <g>
            {/* {console.log(imgUrl)} */}
        ...
        <span
          style={{ padding: "6px", borderRadius: "50px" }}
          id={this.props.buttonId}
          className="submitNewTweet"
          onClick={e => {
            this.props.submitForm(e, this.state.author, this.state.description);
          }}
        >
          Tweet
        </span>
